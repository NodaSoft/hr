...
// - Добавила глобальный переменные, чтоб было проше настраивать и тестить программу ()

// Не претендую, что код подвергся достаточному рефакторингу, исходила из желания,
// чтоб он ста более читаем, действительно выводил каждые 3 секунды результаты проделанных работ, чтоб не было гонки и прочих проблем горутин
